...
@Component({
    selector: 'nfe-infAdic-tab',
    templateUrl: 'nfe-infAdic-tab.component.html',
    ...
    providers: [
        {
            ...
            multi: true,
            useExisting: NFeInfAdicTabComponent
        }
    ]
})

export class NFeInfAdicTabComponent implements ControlValueAccessor, OnDestroy {
